...
#import "Masonry.h"
@interface FirstViewCtrl ()<WRTopBarViewDelegate>
...
- (void)viewDidLoad {
    ...
    _titleArr=@[@"标题1",@"标题2",@"标题3",@"标题4",@"标题5",@"标题6",@"标题7"];
...
-(UIView *)createSelectViewWithSelectBtn:(UIButton *)selectBtn AndbtnArr:(NSMutableArray *)btnArr{
    CGRect Btnframe=selectBtn.frame;
    CGRect frameMain=self.topBarView.frame;
    CGFloat X=frameMain.origin.x+frameMain.size.width-Btnframe.size.width;
    WRSelectMenuView * selectMenu=[[WRSelectMenuView alloc] initWithFrame:CGRectMake(X, 40, Btnframe.size.width, btnArr.count*(40-2)) style:UITableViewStylePlain];
    
    selectMenu.btnArr=btnArr;
    [selectMenu reloadData];
