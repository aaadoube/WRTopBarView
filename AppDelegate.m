...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FirstViewCtrl * firstVC=[[FirstViewCtrl alloc] init];
    firstVC.view.backgroundColor=[UIColor whiteColor];
    firstVC.tabBarItem.title=@"first";
    firstVC.tabBarItem.image=[UIImage imageNamed:@"tab_recent_nor"];
    
    SecondViewCtrl * secondVC=[[SecondViewCtrl alloc] init];
    secondVC.view.backgroundColor=[UIColor orangeColor];
    secondVC.tabBarItem.title=@"second";
    secondVC.tabBarItem.image=[UIImage imageNamed:@"tab_recent_nor"];
